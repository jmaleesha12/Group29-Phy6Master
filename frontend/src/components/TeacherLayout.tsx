      ...
      <div className="min-h-screen bg-background flex">
        ...
        >
          ...
          <header className="sticky top-0 z-30 flex items-center justify-between gap-4 border-b border-border bg-background/80 backdrop-blur-md px-6 py-3">
            ...
            {/* Sidebar toggle — was an empty div before */}
              ...
              <div className="relative">
                ...
                >
                  <div className="h-8 w-8 rounded-full bg-primary text-primary-foreground flex items-center justify-center text-xs font-bold">
                    {(localStorage.getItem("authName") || "T")[0].toUpperCase()}
                  </div>
                  <span className="text-sm font-medium text-foreground hidden sm:block">
                  {localStorage.getItem("authName") || "Teacher"}
                </span>
                ...
                <AnimatePresence>
                  {profileOpen && (
                      ...
                      >
                        ...
                        <button
                            onClick={handleLogout}
                            className="flex items-center gap-2 px-3 py-2 rounded-lg text-sm text-destructive hover:bg-accent w-full"
                        >
