...
import {
  ...
  GraduationCap, LogOut, ChevronDown, Bell, ClipboardCheck, Menu, X,
  FileText, Bot,
} from "lucide-react";
                ...
                <AnimatePresence>
                  {profileOpen && (
                      <motion.div initial={{ opacity: 0, y: 5 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: 5 }}
                        ...
                        <Link to="/student/settings" onClick={() => setProfileOpen(false)} className="flex items-center gap-2 px-3 py-2 rounded-lg text-sm text-foreground hover:bg-accent"><User className="h-4 w-4" /> Profile</Link>
