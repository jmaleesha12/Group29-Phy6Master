...
import { Video, BookOpen, CalendarDays, Clock } from "lucide-react";
...
export function Dashboard() {
  ...
  // ✅ FIX: define upcomingClasses properly
  const upcomingClasses = todaySlots;
                ...
                {upcomingClasses.map((c) => (
                    <div key={c.id} className="flex items-center justify-between p-3 rounded-lg bg-secondary">
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">
                          {dayDisplayName(c.dayOfWeek)} | {formatTime(c.startTime)}
                        </p>
                      </div>
